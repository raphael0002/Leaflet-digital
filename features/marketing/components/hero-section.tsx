...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative isolate min-h-screen overflow-hidden bg-[#080706] pt-8 md:pt-12 lg:pt-16"
    >
      {/* Background */}
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="hero-cloud hero-cloud-left absolute left-[-12%] top-[8%] h-[760px] w-[920px] rounded-full bg-[radial-gradient(circle,rgba(248,130,33,0.16)_0%,rgba(248,130,33,0.10)_28%,rgba(132,74,32,0.07)_48%,rgba(74,39,18,0.045)_64%,transparent_78%)] blur-[92px]"
          />
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={heroViewport}
            className="hero-cloud hero-cloud-right absolute right-[-12%] top-[12%] h-[780px] w-[940px] rounded-full bg-[radial-gradient(circle,rgba(255,152,54,0.14)_0%,rgba(248,130,33,0.09)_30%,rgba(128,70,30,0.065)_50%,rgba(70,36,17,0.04)_66%,transparent_80%)] blur-[96px]"
          />
        </div>
      </div>

      <Container wide className="relative flex min-h-screen flex-col justify-center">
        <div className="mx-auto max-w-[980px] text-center">
          ...
          >
            <motion.h1
              variants={heading}
              className="mx-auto text-left text-balance font-heading text-[36px] font-extrabold leading-[1.12] tracking-normal text-[#f8f1ea] sm:text-center sm:text-[58px] md:text-[70px] lg:text-[76px]"
            >
            ...
            <motion.p
              variants={subtitle}
              className="mx-auto mt-7 max-w-[900px] text-left text-balance text-[14px] font-medium leading-7 text-white/46 sm:text-center sm:text-[17px]"
            >
            ...
            <motion.div variants={ctaRow} className="mt-9 w-full">
              <motion.div
                variants={ctaButtons}
                initial="hidden"
                whileInView="visible"
                viewport={heroViewport}
                className="flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-7"
              >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={heroViewport}
          className="mx-auto mt-8 w-full max-w-[1400px] sm:mt-20"
        >
          <motion.p
            variants={logoLabel}
            className="text-center font-mono text-[11px] uppercase tracking-[0.24em] text-white/20"
          >
